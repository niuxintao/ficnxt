...
public class CharacterWorkMachine {
	 ...
	 * @return
	 */
	private boolean isTupleUnderTestExist() {
	 ...
	 * @return
	 */
	private TestCase generateTestCaseContainTuple(Tuple tuple) {
	 ...
	 * @return
	 */
	private boolean runTest(TestCase testCase) {
	 ...
	 * @param tuple
	 */
	private void setAllFathersAndItselfBug(Tuple tuple) {
	 ...
	 * @param tuple
	 */
	private void setAllChildrenAndItselfRight(Tuple tuple) {
